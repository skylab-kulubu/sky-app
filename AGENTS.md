...
| `dio`                      | All REST calls                                                                                             |
| `image_picker`             | Event cover and news image (`MediaService.pickImage`, `CoverPicker`) — **native dependency**, iOS needs `NSPhotoLibraryUsageDescription` |
