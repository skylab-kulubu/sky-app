...
class ActiveTicketsPage extends StatefulWidget {
  const ActiveTicketsPage({super.key});

  @override
  State<ActiveTicketsPage> createState() => _ActiveTicketsPageState();
}

class _ActiveTicketsPageState extends State<ActiveTicketsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_tickets.isEmpty) {
      return const Center(child: Text('Aktif biletiniz bulunmuyor.'));
    }
